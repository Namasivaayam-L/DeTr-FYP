...
def get_detr_model(config, include_top=False, nb_class=None, weights=None, tf_backbone=False, num_decoder_layers=6, num_encoder_layers=6, custom_objects=None):
    """ Get the DETR model
    ...
    if weights is not None:
        load_weights(detr, weights, custom_objects)
